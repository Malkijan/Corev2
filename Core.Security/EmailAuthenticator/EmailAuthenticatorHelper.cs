...
{
    public class EmailAuthenticatorHelper : IEmailAutenticatorHelper
    {
        ...
        {
            string code = RandomNumberGenerator.GetInt32
                (Convert.ToInt32(Math.Pow(10, 6))).ToString().PadLeft(6, '0');
